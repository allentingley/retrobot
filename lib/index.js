        ...
        slack.dnd.info({ token, user }, (error, dnd) => {
          ...
          slack.users.getPresence({ token, user }, (error, presence) => {
            ...
            slack.im.open({ token, user }, (error, data) => {
              ...
              reply({ channel: dms[user] }, '👂 Hi! I\'m Retrobot. \n\nI\'m here to collect feedback about the most recent sprint at Acrobatiq for our retrospective.' +
                '\n\nTell me about your experience this sprint. I will collect the team\'s thoughts, and then we will vote as a group to determine adjustments we will make.' +
