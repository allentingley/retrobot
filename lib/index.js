...
function captureRetrospective(message) {
  ...
  if (type == '+') { 
    reply(message, `I've added \`${line}\` to the "worked well" list for the retrospective.`);
  }
  if (type == '-') { 
    reply(message, `I've added \`${line}\` to the "needs improvement" list for the retrospective.`);
  }
